...
/** Location
    ...
    positions (x to the right and y down).
 	...
 	Location提供locations位置（转化为长度的位置） 与 代表屏幕像素坐标的points点相互转换点方法。
    ...
    - a scale specifying how many pixels per length unit.
 	...
 	转换条件：
 	- 地图原始坐标
 	- 一个长度单元代表多少像素（通常是：屏幕大小/(maxLocation - minLocation)）
   */
...
public class Location{
    ...
    */
	...
	//  private static final double centerLat = 39.907672;  // the center of beijing City!
	//  private static final double centerLon = 116.397632;  // according to gaode Maps
    ...
    */
    ...
    public double distanceTo(Location other,int type){
		if (type == TRIANGLE) {
    ...
    */
	...
	Location place = new Location(20.0, 200.0);
